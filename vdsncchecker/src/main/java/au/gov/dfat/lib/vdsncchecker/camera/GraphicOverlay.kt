...
class GraphicOverlay(context: Context?, attrs: AttributeSet?) :
    ...
    private fun translateX(x: Float): Float = x * scaleFactor
    private fun translateY(y: Float): Float = y * scaleFactor
    ...
    init {
        // Ensure we use hardware acceleration for this view
        // Prevents a "black box" drawing error on lower Android API versions
