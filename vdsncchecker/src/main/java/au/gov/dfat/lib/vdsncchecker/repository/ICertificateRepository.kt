...
/**
 *
 * Interface for implementing Certificate Repository
 *
 */
interface ICertificateRepository {
    fun findIssuer(certificate: ByteArray, certFactory: CertificateFactory): CertificateData?
    fun addCertificate(certificate: ByteArray, hash: String, clr: CRLStoreWrapper)
    fun addCertificate(certificate: CertificateData)
